...
<span class="cstat-no" title="statement not covered">        if (tries-- &gt; 0) <span
									class="cstat-no" title="statement not covered">return _getUniqueName();</span>
							</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered">  process.addListener('uncaughtException', <span
									class="fstat-no" title="function not covered">function _uncaughtExceptionThrown(err) {</span>
							</span>
...
<span class="cstat-no" title="statement not covered">  if (code) <span
									class="cstat-no" title="statement not covered">_uncaughtException = true;</span>
							</span>
<span class="cstat-no" title="statement not covered">  _garbageCollector();</span>
});
&nbsp;
...
&nbsp;</pre>
	...
	<div class='footer quiet pad2 space-top1 center small'>
		...
		at Tue Sep 20 2016 12:42:12 GMT+0200 (CEST)
	</div>
	</div>
