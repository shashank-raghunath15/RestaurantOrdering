...
<body>
	<div class="nav">
		<a href="index.html">Forge Tests</a>
		/ Form
	</div>
	...
	<div class="content">
		...
		<form id="form-1" class="ajax standard" method="post" action="">
			...
			<fieldset>
				...
				<p>
					<label>
						<input name="checkbox1" type="checkbox" value="c1" />
						C1
					</label>
					<label>
						<input name="checkbox1" type="checkbox" value="c2" />
						C1
					</label>
					<label>
						<input name="checkbox1" type="checkbox" value="c3" />
						C1
					</label>
				</p>
				...
				<p>
					<label>
						<input name="checkbox2[]" type="checkbox" value="c1" />
						C2[]
					</label>
					<label>
						<input name="checkbox2[]" type="checkbox" value="c2" />
						C2[]
					</label>
					<label>
						<input name="checkbox2[3]" type="checkbox" value="c3" />
						C2[3]
					</label>
					<label>
						<input name="checkbox2[]" type="checkbox" value="c4" />
						C2[]
					</label>
					<label>
						<input name="checkbox2.sub1" type="checkbox" value="c4" />
						C2.sub1
					</label>
				</p>
				...
				<p>
					<label>
						<input name="checkbox3.sub1" type="checkbox" value="c1" />
						C3.s1
					</label>
					<label>
						<input name="checkbox3.sub2" type="checkbox" value="c2" />
						C3.s2
					</label>
					<label>
						<input name="checkbox3.sub2" type="checkbox" value="c3" />
						C3.s2
					</label>
					<label>
						<input name="checkbox3[]" type="checkbox" value="c4" />
						C3[]
					</label>
				</p>
			</fieldset>
			...
			<fieldset>
				...
				<p>
					<label>
						<input name="radio1" type="radio" value="r1" />
						R1
					</label>
					<label>
					...
					<label>
						<input name="radio1" type="radio" value="r4" />
						R1
					</label>
				</p>
				...
				<p>
					<label>
						<input name="radio2.sub1" type="radio" value="r1" />
						R2.s1
					</label>
					<label>
						<input name="radio2.sub1" type="radio" value="r2" />
						R2.s1
					</label>
					<label>
						<input name="radio2.sub2" type="radio" value="r3" />
						R2.s2
					</label>
					<label>
						<input name="radio2.sub2" type="radio" value="r4" />
						R2.s2
					</label>
				</p>
			</fieldset>
			...
			<fieldset>
				...
				<p>
					<button name="button1" type="submit" value="submit">Submit
						Form</button>
					<button name="button2" type="reset" value="reset">Reset
						Form</button>
				</p>
			</fieldset>
