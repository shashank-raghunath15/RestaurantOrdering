	...
	<div class="content">
		...
		<fieldset class="section">
			...
			<div id="random_controls">
				<button id="random" onclick="javascript:return test_random();">paint
					random</button>
				<button id="clear" onclick="javascript:return canvas_clear();">clear</button>
			</div>
			<canvas id="canvas" width="100" height="100"></canvas>
			<div id="buffer_controls">
				<button id="buffer_fill"
					onclick="javascript:return test_buffer_fill();">buffer
					fill</button>
				<button id="buffer_xor"
					onclick="javascript:return test_buffer_xor();">buffer xor</button>
			</div>
			<div id="base64_controls">
				<button id="base64_encode"
					onclick="javascript:return test_base64_encode();">base64
					encode</button>
				<button id="base64_decode"
					onclick="javascript:return test_base64_decode();">base64
					decode</button>
			</div>
			...
			<div id="aes_controls">
				...
				<button id="aes_128_cbc" onclick="javascript:return aes_128_cbc();">aes-128
					cbc</button>
			</div>
		</fieldset>
	</div>
