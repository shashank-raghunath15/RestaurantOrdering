...
<head>
<meta name="author"
	content="Digital Bazaar, Inc.; http://digitalbazaar.com/" />
...
<body>
	...
	<div class="content">
		...
		<fieldset class="section">
			...
			<ul>
				...
				<li>
					<a href="socketPool.html">SocketPool</a>
					<sup>1</sup>
				</li>
				<li>
			...
			<div>
				<span>
					<sup>1</sup>
					: Test works over HTTP
				</span>
				<br />
				<span>
					<sup>2</sup>
					: Test works over HTTPS
				</span>
			</div>
		</fieldset>
	</div>
	<div class="footer">
		Copyright &copy; 2010
		<a href="http://digitalbazaar.com/">Digital Bazaar, Inc.</a>
	</div>
</body>
</html>
