	...
	<div class="content">
		...
		<fieldset class="section">
			...
			<table>
				<tr>
					<td rowspan="3">
						<button id="create">Create Web ID</button>
					</td>
					<td>Bits</td>
					<td>
						<input id="bits" size=8 value="1024" />
					</td>
				</tr>
				<tr>
					<td>URI</td>
					<td>
						<input id="uri" size=60
				...
				<tr>
					<td>Common Name</td>
					<td>
						<input id="commonName" size=20 value="mycert" />
					</td>
				</tr>
				<tr>
					<td>
						<button id="show">Show Web IDs</button>
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>
						<button id="clear">Delete Web IDs</button>
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>
						<button id="authenticate">Authenticate using Web ID</button>
					</td>
					<td>URI</td>
					<td>
						<input id="webid" size=60
							value="http://localhost/dataspace/person/myname#this" />
					</td>
				</tr>
			</table>
