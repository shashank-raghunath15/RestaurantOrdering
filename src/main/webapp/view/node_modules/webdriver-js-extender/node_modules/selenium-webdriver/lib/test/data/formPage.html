...
<body>
	...
	<form method="get" action="resultPage.html" name="optional"
		...
		<input type="checkbox" id="checkedchecky" name="checkedchecky"
			checked="checked" />
		<input type="checkbox" id="disabledchecky" disabled="disabled"
			name="disabledchecky" />
		<input type="checkbox" id="randomly_disabled_checky"
		...
		<input type="radio" id="cheese" name="snack" value="cheese" />
		Cheese
		<br />
		<input type="radio" id="peas" name="snack" value="peas" />
		Peas
		<br />
		<input type="radio" id="cheese_and_peas" name="snack"
			value="cheese and peas" checked />
		Cheese and peas
		<br />
		<input type="radio" id="nothing" name="snack" value="nowt"
			disabled="disabled" />
		Not a sausage
		<br />
		<input type="radio" id="randomly_disabled_nothing" name="snack"
			value="funny nowt" disabled="somedisablingstring" />
		Not another sausage
		...
		<input type="radio" id="lone_disabled_selected_radio"
			name="not_a_snack" value="cumberland" checked="checked"
			disabled="disabled" />
		Cumberland sausage
	</form>
	...
	<form method="get" action="xhtmlTest.html">
		<p>
			...
			<input type="submit" id="disabledSubmitElement" disabled="qwerty"
				value="Submit" />
		</p>
	</form>
	...
	<form method="get" action="formPage.html">
		<p>
			<label for="checkbox-with-label" id="label-for-checkbox-with-label">Label</label>
			<input type="checkbox" id="checkbox-with-label" />
		</p>
	</form>
