	...
	<div class='wrapper'>
		<div class='pad1'>
			<h1>
				...
				/
				<a href="index.html">lib/spdy-transport/</a>
				stream.js
			</h1>
			<div class='clearfix'>
...
<span class="cstat-no" title="statement not covered">    if (callback) { <span
									class="cstat-no" title="statement not covered">process.nextTick(callback) }</span>
							</span>
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered">    if (err) { <span
									class="cstat-no" title="statement not covered">push.emit('error', err) }</span>
							</span>
  })
  push._hardCork()
&nbsp;
